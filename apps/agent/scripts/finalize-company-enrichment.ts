...
const headers = [
	...
	"company_type_suggestion_evidence",
	"company_type_status",
...
const summaryText = `${JSON.stringify(
	{
		...
		notes: [
			...
			"Keyword suggestions can help human review, but company type remains unclassified until a person approves it.",
			"Company-type suggestions never overwrite the reviewed company_type field.",
