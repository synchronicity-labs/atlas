UPDATE "question"
SET "description" = 'Every non-deleted failed generation from the rolling 24-hour window, newest first, capped at 2,000 rows. Error messages are URL-redacted and truncated; raw inputs, webhook URLs, media URLs, tokens, and payloads are excluded.',
...
INSERT INTO "questionVersion" (
  ...
  'atlas-product-version-failed-generations-v2',
  'atlas-product-question-failed-generations', 2, 'SQL',
  $query$select
  created_at,
...
SET "displaySettings" = coalesce("displaySettings", '{}'::jsonb)
      || '{"timeframe":"Last 24 rolling hours · newest first · max 2,000 · UTC","visibleRows":"all"}'::jsonb,
    "updatedAt" = CURRENT_TIMESTAMP
